...
class ColourPickerCtrl(wx.ColourPickerCtrl):
    ...
    def __init__(self, parent, col, name):
        wx.ColourPickerCtrl.__init__(self, parent=parent, id=-1, colour=col,
...
class Panel(wx.Panel):
    ...
    def __init_renamecolor_sizer(self, parent):
        ...
        parent.Add(self.willChangeColorTxt, 0,
                         flag=wx.ALIGN_CENTER_VERTICAL, border=0)
        parent.Add(self.willChangeColor, 0, flag=0, border=0)

        parent.Add(self.renamedColorTxt, 0,
                         flag=wx.ALIGN_CENTER_VERTICAL, border=0)
        parent.Add(self.renamedColor, 0, flag=0, border=0)


        parent.Add(self.errorColorTxt, 0,
                         flag=wx.ALIGN_CENTER_VERTICAL, border=0)
        parent.Add(self.errorColor, 0, 0, border=0)

        parent.Add(self.warnColorTxt, 0,
                         flag=wx.ALIGN_CENTER_VERTICAL, border=0)
        parent.Add(self.warnColor, 0, 0, border=0)
    ...
    def __init_sizers(self):
        ...
        self.mainSizer.Add(wx.Size(8, 8), border=0, flag=0)
        self.mainSizer.Add(self.renameColorSizer, 0,
                                flag=wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, border=10)
        self.mainSizer.Add(self.setDefaultsBtn, 0,
